...
impl<'de> Visitor<'de> for AbiObjectVisitor {
        ...
        A: MapAccess<'de>,
    {
        ...
        impl<'de> Deserialize<'de> for DeserializeBytes {
            ...
            {
                Ok(DeserializeBytes(
                    crate::types::deserialize_bytes(deserializer)?.into(),
                ))
            }
        }
...
mod tests {
    ...
    fn can_parse_raw_abi() {
        const VERIFIER_ABI: &str =
            include_str!("../../../contract/tests/solidity-contracts/verifier_abi.json");
    ...
    fn can_parse_hardhat_raw_abi() {
        const VERIFIER_ABI: &str =
            include_str!("../../../contract/tests/solidity-contracts/verifier_abi_hardhat.json");
        let _ = serde_json::from_str::<RawAbi>(VERIFIER_ABI).unwrap();
    }
    ...
    fn can_parse_greeter_bytecode() {
        let artifact = include_str!("../../../contract/tests/solidity-contracts/greeter.json");
