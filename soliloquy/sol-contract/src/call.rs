...
mod tests {
    ...
    fn change_max_fee_per_gas() {
        ...
        assert_eq!(
            call_builder
                .request
                .max_fee_per_gas
                .expect("max_fee_per_gas should be set"),
            42,
    ...
    fn change_max_fee_per_blob_gas() {
        ...
        assert_eq!(
            call_builder
                ...
                .expect("max_fee_per_blob_gas should be set"),
            50,
    ...
    fn change_access_list() {
        ...
        assert_eq!(
            call_builder
                .request
                .access_list
                .expect("access_list should be set"),
            access_list,
    ...
    async fn deploy_and_call() {
        ...
        assert_eq!(
            my_state_builder.calldata()[..],
            MyContract::myStateCall {}.abi_encode(),
        );
