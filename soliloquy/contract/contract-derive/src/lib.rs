...
///
/// [`AbiType`]: soliloquy_core::abi::AbiType
///
/// # Examples
///
/// ```
/// use ethers_contract_derive::EthAbiType;
/// use soliloquy_core::types::*;
/// use soliloquy_core::abi::{AbiType, ParamType};
///
...
///
/// [`AbiEncode`]: soliloquy_core::abi::AbiEncode
/// [`AbiDecode`]: soliloquy_core::abi::AbiDecode
///
...
/// use soliloquy_core::abi::{AbiDecode, AbiEncode};
///
...
/// use soliloquy_core::abi::{Address, FunctionExt};
///
/// #[derive(EthCall)]
...
///
/// ```ignore
/// use soliloquy_core::abi::{Address, EventExt};
/// use ethers_contract_derive::EthCall;
///
...
///
/// ```ignore
/// use soliloquy_core::abi::{Address, ErrorExt};
...
///
/// [`Tokenizable`]: soliloquy_core::abi::Tokenizable
///
...
/// use soliloquy_core::types::{transaction::eip712::Eip712, H160};
///
