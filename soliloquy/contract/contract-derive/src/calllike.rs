...
pub fn derive_decode_impl(datatypes_array: TokenStream, trait_ident: Ident) -> TokenStream {
    ...
    quote! {
        ...
        #data_types_init
        let data_tokens = #soliloquy_core::abi::decode(&data_types, &bytes[4..])?;
        Ok(<Self as #soliloquy_core::abi::Tokenizable>::from_token(#soliloquy_core::abi::Token::Tuple(data_tokens))?)
    }
}
